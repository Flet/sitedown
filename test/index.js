...
var generatedRewriteHttpfooMdWithAnchor = '<p><a href="httpfoo.html#blarg">rewrite</a></p>'
...
test('rewrite markdown links starting named http and preserve anchors', function (t) {
  var file = path.join(__dirname, 'markdown', 'rewritehttpfoowithanchor.md')
  var body = sitedown.mdToHtml(file)
  var html = sitedown.buildPage('', body, '')
  t.equals(html, generatedRewriteHttpfooMdWithAnchor, 'markdown link rewritehttpfoowithanchor.md got rewritten')
  t.end()
})
...
test.only('site generation', function (t) {
  ...
  function generateSite () {
    sitedown(opts, function (err) {
      ...
      var rewriteWithAnchor = fs.readFileSync(path.join(opts.build, 'rewritehttpfoowithanchor', 'index.html'), enc)
      ...
      t.ok(rewriteWithAnchor, 'generated link rewrite file exists')
      t.equals(rewriteWithAnchor, '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title></title>\n</head>\n<body>\n  <div class="markdown-body"><p><a href="httpfoo/#blarg">rewrite</a></p>\n</div>\n</body>\n</html>\n', 'rewrite file looks okay')
